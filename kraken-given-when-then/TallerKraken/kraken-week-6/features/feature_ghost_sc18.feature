Feature: Login error, login success, list post, create post with big title and list post 
        @user1 @web
        Scenario: Ingresar con cuenta invalida, Ingresar con cuenta válida, Listar Posts, Crear Post (500 caracteres), Listar Posts
