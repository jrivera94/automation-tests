Feature: Login error, login sucess, list post, edit and list post
        @user1 @web
        Scenario: Ingresar con cuenta invalida, Ingresar con cuenta válida, Listar Posts, Editar Post, Listar Posts
