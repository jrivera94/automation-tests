Feature: Login error, login success, list post, create post, list post, create and list post
        @user1 @web
        Scenario: Ingresar con cuenta invalida, Ingresar con cuenta válida, Listar Posts, Crear Post, Listar Posts, Crear Post, Listar Post
		...
		Then I navigate to page "<POST_CREATOR_2>"
		Then I click on element having css selector ".gh-editor-title"
                Then I enter "<TITLE_POST_2>" into input field having css selector "textarea"
                Then I enter "<DESCRIPTION_POST_2>" into input field having css selector "p"
