Feature: Login error, login success, list post, create post, list post, edit post, publish and list post
        @user1 @web
        Scenario: Ingresar con cuenta invalida, Ingresar con cuenta válida, Listar Posts, Crear Post, Listar Posts, Editar Post, Publicar Post, Listar Post
